...
public class jUnibrainParser extends DefaultHandler
{
	...
	private ArrayList<UnibrainFrame> frames= new ArrayList<UnibrainFrame>();
	private UnibrainFrame CurrentFrame; 
	
	public jUnibrainParser(String pathXMLfile) throws IOException
	{
	...
	public UnibrainFrame[] parseFile()
	{
		UnibrainFrame [] frameArray=new UnibrainFrame[0];
	...
	public void characters(char[] buffer, int start, int length) 
	{
	  ...
	  public void startElement(String namespaceURI, String localName,String qName, Attributes atts) 
	  {
		  ...
		  {
			  CurrentFrame = new UnibrainFrame();
