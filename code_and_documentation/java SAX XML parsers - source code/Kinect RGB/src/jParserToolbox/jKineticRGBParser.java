...
public class jKineticRGBParser extends DefaultHandler
{
	...
	private ArrayList<KineticRGBFrame> frames= new ArrayList<KineticRGBFrame>();
	private KineticRGBFrame CurrentFrame;
	
	public jKineticRGBParser(String pathXMLfile) throws IOException
	{
	...
	public KineticRGBFrame[] parseFile()
	{
		KineticRGBFrame [] frameArray=new KineticRGBFrame[0];
	...
	public void characters(char[] buffer, int start, int length) 
	{
	  ...
	  public void startElement(String namespaceURI, String localName,String qName, Attributes atts) 
	  {
		  ...
		  {
			  CurrentFrame = new KineticRGBFrame();
