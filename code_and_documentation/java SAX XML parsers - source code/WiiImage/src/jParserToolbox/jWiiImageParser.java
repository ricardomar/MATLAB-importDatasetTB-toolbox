...
public class jWiiImageParser extends DefaultHandler
{
	...
	private ArrayList<WiiImageFrame> frames= new ArrayList<WiiImageFrame>();
	private WiiImageFrame CurrentFrame;
	
	public jWiiImageParser(String pathXMLfile) throws IOException
	{
	...
	public WiiImageFrame[] parseFile()
	{
		WiiImageFrame [] frameArray=new WiiImageFrame[0];
	...
	public void characters(char[] buffer, int start, int length) 
	{
	  ...
	  public void startElement(String namespaceURI, String localName,String qName, Attributes atts) 
	  {
		  ...
		  {
			  CurrentFrame = new WiiImageFrame();
